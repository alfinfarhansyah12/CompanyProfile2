                        ...
                        <tbody>
                          ...
                          ?>
                              <tr style="<?php echo $rowStyle; ?>">
                                ...
                                <!-- GANTI JADI MOBILE ALFIN -->
                                <td><?php echo $formatted_datetime; ?></td>
                                <td><?php if ($row['service_type'] == "Complaint") : ?>
                                    <button class="btn btn-sm btn-danger">
                                      <?php echo $row['service_type']; ?>
                                    </button>
                                  <?php elseif ($row['service_type'] == "Pengaduan") : ?>
                                ...
                                <td>
                                  <div class="btn-group gap-1" role="group" aria-label="Button group with icons">
                                    ...
                                    <button type="button" class="btn btn-warning btn-sm edit-btn" data-bs-toggle="modal"
                                      ...
                                      data-phone="<?php echo $row['customer_phone']; ?>"
                                      data-note="<?php echo $row['customer_note']; ?>"
                                      data-status="<?php echo $row['customer_status']; ?>"
                                      data-service="<?php echo $row['service_type']; ?>">
        ...
        <div class="modal-body">
          <form id="editForm" method="POST" action="view_orders.php">
            ...
            <div class="mb-3">
              ...
              <input type="text" class="form-control" id="editPhone" name="customer_phone" readonly>
            </div>
            <div class="mb-3">
              <label for="editNote" class="form-label">Note</label>
              <input type="text" class="form-control" id="editNote" name="customer_note" readonly>
            </div>
            <div class="mb-3">
            ...
            <div class="mb-3">
              <label for="editServiceType" class="form-label">Jenis Layanan</label>
              <select class="form-select" id="editServiceType" name="service_type" required>

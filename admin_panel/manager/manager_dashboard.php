    ...
    <div id="content">
      ...
      <div class="main-content">
        ...
        <div class="delivery_infos">
          ...
          <label class="col-sm-3 col-md-4 control-label">Delivery cost: <span id="cost">Rp
              <?php echo $row['delivery_cost']; ?> </span> </label>
                    ...
                    <tr>
                      ...
                      <td>
                        <button class="delete_currency" id="<?php echo $row['currency_id'] ?>">
                          <span class="iconify" data-icon="fluent:delete-24-filled" style="color: red;" data-width="30"
                            data-height="30"></span>
                        </button>
                      </td>
                      <?php } ?>
